...
#[doc(inline)]
pub use telemetry::{
    compare_metrics, cuda_memory_snapshot, init_tracing, read_metrics, run_span, summarize,
    Anomaly, GpuMemorySnapshot, Metrics, MetricsWriter, RegressionBudget, RegressionFailure,
